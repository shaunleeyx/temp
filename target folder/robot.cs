...
//C++ TO C# CONVERTER TODO TASK: 'rvalue references' have no equivalent in C#:
	public robot(robot && obj)
	{
		swap(ref sObj, ref obj.sObj);
		swap(ref rCoord, ref obj.rCoord);
		swap(ref cCoord, ref obj.cCoord);
		swap(ref state, ref obj.state);
		swap(ref nAct, ref obj.nAct);
		swap(ref sAct, ref obj.sAct);
		swap(ref wAct, ref obj.wAct);
